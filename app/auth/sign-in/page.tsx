    ...
    return (
        <section className="flex h-screen w-screen items-center justify-center bg-[#F8F8F8] gap-15 px-5 ">
            <div className="flex flex-col items-start justify-center gap-2 w-[45%] px-30 ">
                ...
                <h2 className="text-[#131313] font-semibold text-3xl">Hi, Welcome</h2>
                <h3 className="text-[#131313]/30 text-lg">Please login to your account</h3>
                ...
                <div className="w-full">
                    <button onClick={() => { }} className="bg-primary border border-primary w-full h-10 rounded-lg text-white font-semibold text-sm cursor-pointer shadow-[inset_6px_6px_10px_#565657] mt-10">Sign In</button>
                </div>
                ...
                <div className="flex justify-center items-center w-full mt-3">
                    <button onClick={() => {
                        ...
                        <p className="text-primary/40 text-xs">Don't have an account?</p>
                        <p className="text-primary text-xs font-semibold cursor-pointer">Register</p>
                    </button>
                </div>
